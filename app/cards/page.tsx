...
export default function CardsDirectoryPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-extrabold text-brand-900 sm:text-3xl">All Cards</h1>
      <p className="mt-1 text-sm text-gray-600">{cards.length} cards currently tracked.</p>
